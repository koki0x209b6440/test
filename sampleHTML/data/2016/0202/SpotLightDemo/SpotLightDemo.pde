...
/*
　spotlightのテスト。なんか、削除できないpointLightもあるが。
　その奇麗さのネタは、sphereDetailとemissive
　上手いことprocessingを活かせているなぁ。

　あと、setLightで小星の移動も管理しているが、惑星っぽく移動させているのが上手い
   (ちなみに、星軌道させている真ん中に、でかい球を置いているだけ。”星に沿って”ではない)
*/
/*
　いや、この軌道美なんかはP3Dの代表サンプルに相応しいかも。
　個人的には、dragball2(特にバウンドな所)とこいつが3Dの代表格っぽい
*/

/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/59268*@* */
...
void setLights()
{
  ...
  pz=100;
  pointLight(red(c3), green(c3), blue(c3),  // color //なんかココのpointLightも重要みたいなのだが、なぜだ？
             px, py, pz);                   // position  
}
