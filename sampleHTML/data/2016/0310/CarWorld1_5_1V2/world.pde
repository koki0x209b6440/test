...
{
  WorldBoxll(float ix1, float iy1, float iz1, float ix2, float iy2, float iz2, float framerate)
  {
    super(ix1,iy1,iz1,ix2,iy2,iz2,framerate);
  }
  ...
  float gravZ(float ix, float iy, float iz)    { return -grav; }
}
