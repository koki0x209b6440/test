...
public class Lamp {
  ...
  Lamp(float x,float y,float z,float scaleSize)
  {
    this.x=x;
    this.y=y;
    this.z=z;
  ...
  void syncXYZ_objXYZ()
  {
    ...
    frame(1).setTranslation(0, 0, 8*scaleSize);   //ランプの土台部分。ランプの一回折れるとこまで(ここらへんに書きますよー、の意味)
    frame(2).setTranslation(0, 0, 50*scaleSize);  //棒一個上のとこ
    frame(3).setTranslation(0, 0, 50*scaleSize);  //棒一個上のとこ。ランプの笠がある辺り
  }
  ...
  public void drawBase()
  {
    //scale(scaleSize);
    //box(30);
    drawConeV2(0, 3, 15, 15, 30);
    drawConeV2(3, 5, 15, 13, 30);
    drawConeV2(5, 7, 13, 1, 30);
    drawConeV2(7, 9, 1, 1, 10);
  }
  
  public void drawArm()
  {
    translateV2(2, 0, 0);
    drawConeV2(0, 50, 1, 1, 10);//stick
  ...
  {
    drawConeV2(-2, 6, 4, 4, 30);
    drawConeV2(6, 15, 4, 17, 30);
    drawConeV2(15, 17, 17, 17, 30);
  }
  public void drawCylinder()
  {
    pushMatrix();
    rotate(HALF_PI, 0, 1, 0);
    drawConeV2(-5, 5, 2, 2, 20);
    popMatrix();
  }
  
  
  public void drawConeV2(float zMin, float zMax, float r1, float r2, int nbSub)
  {
    drawCone(zMin*scaleSize,zMax*scaleSize,r1*scaleSize,r2*scaleSize,nbSub);
  }
  ...
  public void translateV2(float x,float y,float z)
  {
    translate( (float)(x*scaleSize),   (float)(y*scaleSize),   (float)(z*scaleSize) );
  }
