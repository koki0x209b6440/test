...
{
  float x,y,z;
  SpotlightTest(float x,float y,float z)
  {
  ...
  void setLights()
  {
    ...
    c1 = color(204, 153, 0);
    sx=80*15*cos(frameCount*0.02);
    sy=60*15*sin(frameCount*0.02);
    sz=200;
    ...
    px=-80*15*cos(frameCount*0.015);
    py=-80*15*sin(frameCount*0.021);
    pz=100;
