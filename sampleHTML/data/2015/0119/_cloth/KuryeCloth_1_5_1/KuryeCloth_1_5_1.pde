/*
　ライブラリに頼ってる。うう、でもめっちゃ奇麗な3D布だ……読んでみてもいいかも。
　でも、他の3D物と当たり判定の実装し方が、当然全然違うから、さて活用しようって段階で詰むのよね。
 
*/

/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/9826*@* */
...
boolean isGouraudShaded=false;
boolean showSpheres=true;
